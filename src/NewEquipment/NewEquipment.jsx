...
const NewEquipment = () => {
    ...
    const checkFilledForm = () => {
        ...
        //     if(topBarAddData != {img: null, imgName: null}) {
        //         setTopBarAddMissing(true);
        //     } else {
        //         setTopBarAddMissing(false);
        //     }
    
        //     if(topBarData != {img: null, imgName: null}) {
        //         setTopBarMissing(true);
        //     } else {
        //         setTopBarMissing(false);
        //     }
    
        //     if(footData != {img: null, imgName: null}) {
        //         setFootMissing(true);
        //     } else {
        //         setFootMissing(false);
        //     }
    
        //     if(light01Data != {img: null, imgName: null}) {
        //         setLight01Missing(true);
        //     } else {
        //         setLight01Missing(false);
        //     }
    
        //     if(light02Data != {img: null, imgName: null}) {
        //         setLight02Missing(true);
        //     } else {
        //         setLight02Missing(false);
        //     }
    
        //     if(light03Data != {img: null, imgName: null}) {
        //         setLight03Missing(true);
        //     } else {
        //         setLight03Missing(false);
        //     }
    
        //     if(light04Data != {img: null, imgName: null}) {
        //         setLight04Missing(true);
        //     } else {
        //         setLight04Missing(false);
        //     }
    
        //     if(light05Data != {img: null, imgName: null}) {
        //         setLight05Missing(true);
        //     } else {
        //         setLight05Missing(false);
        //     }

        //     statement = titleRefMissing && topBarAddMissing && topBarMissing && footMissing && light01Missing && light02Missing && light03Missing&& light04Missing && light05Missing;
        // } else {
        //     console.log(otherCategoryData);
